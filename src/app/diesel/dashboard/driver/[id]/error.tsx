...
// Error boundary for /diesel/dashboard/driver/[id]. See the truck variant for
// rationale — this surfaces full error message + stack so minified React
// runtime errors don't eat the diagnosis.
...
export default function DriverDetailError({
  ...
  useEffect(() => {
    ...
    console.error('DriverDetail render error:', error);
  }, [error]);
    ...
    <div className="min-h-screen bg-black text-white p-4">
      ...
      <div className="bg-red-950 border border-red-700 rounded-xl p-4 mb-4">
        <div className="flex items-center gap-2 mb-2 text-red-300 font-heading">
          <AlertTriangle size={18} /> DRIVER DETAIL CRASHED
        </div>
