...
export default function CarpenterTrackerLayout({ children }: { children: React.ReactNode }) {
  const router = useRouter();

  const handleLogout = () => {
    sessionStorage.removeItem('carpenter_worker');
    sessionStorage.removeItem('carpenter_code');
